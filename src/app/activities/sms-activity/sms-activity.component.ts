...
import { ActivityDto, ActivityServiceProxy, CreateActivityDto, CustomerDto, NoteActivityInputDto, NoteListDto, NoteListDtoListResultDto, UserDto, UserServiceProxy } from '@shared/service-proxies/service-proxies';
